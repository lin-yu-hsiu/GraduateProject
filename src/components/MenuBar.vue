...
import setting_icon from '../assets/pic/setting_icon.png'
...
import setting_icon_blue from '../assets/pic/setting_icon_blue.png'
...
export default {
  ...
  data() {
    return {
      ...
      setting_icon_blue: setting_icon_blue,
